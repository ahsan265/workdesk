...
return ("0" + minutes).slice(-2) + ":" + ("0" +seconds).slice(-2);
  ...
  ngOnInit(): void {
    ...
    this.selectednumbercalls("incoming","Call type");
    this.selectednumbercalls("ongoing","Call type");
    this.selectednumbercalls("missed","Call type");
    this.selectednumbercalls("finished","Call type");
    this.getlllangugaes();
