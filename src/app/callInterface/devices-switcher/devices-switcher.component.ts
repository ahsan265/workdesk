...
export class DevicesSwitcherComponent implements OnInit {
  ...
  private switchSpeakers(selectedSpeakers: inputOuputdevices, remoteStream: MediaStream) {
    try {
      ...
      let webaudio_source1 = test_audio_context1.createMediaStreamSource(remoteStream);
