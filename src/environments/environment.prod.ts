...
export const environment = {
  ...
  analyticsApi: process.env.ANALYTICS_API || 'https://api.gigaaa.link/v2/analytics',
  ...
  accounts_url: process.env.ACCOUNTS_URL || 'https://accounts.gigaaa.link/oauth',
  accounts_callback_url: process.env.ACCOUNTS_CALLBACK_URL || 'http://localhost:4202',
