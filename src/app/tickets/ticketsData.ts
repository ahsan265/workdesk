...
const oneSelectData2: OneSelect[] = [
  { id: 1, name: 'Assignee', selected: true },
  { id: 1, name: 'Chats', selected: false }
];
const oneSelectData3: OneSelect[] = [
  { id: 1, name: 'Status', selected: true },
  { id: 1, name: 'Chats', selected: false }
];
const priorityData: OneSelect[] = [
  { id: 0, name: 'All priority', selected: true },
  { id: 1, name: 'Urgent', selected: false },
